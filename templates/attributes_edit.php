    ...
    <input name="edit_alt[<?php htmlout($filepath['id']); ?>]" id="edit_alt" value="<?php htmlout($filepath['alt']); ?>">
    <label for="edit_dom_id">DOM Id</label>
    <input name="edit_dom_id[<?php htmlout($filepath['id']); ?>]" id="edit_dom_id" value="<?php htmlout($filepath['dom_id']); ?>">
