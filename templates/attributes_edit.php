...
<label for="edit_alt"><?php echo strtolower($attr); ?></label>
<?php $output = isset($attribute['path']) ? $path : $attribute['alt']; ?>
<input name="edit_alt[<?php htmlout($attribute['id']); ?>]" id="edit_alt" value="<?php htmlout($output); ?>">
<label for="edit_dom_id">id</label>
