		...
		fader = (function () {
			var base_el,
               ...
               // imac = "<a href='http://86.155.78.122/poloafrica/admin?logme=jeff.tracy@tbsrgo.com'>iMac.</a> ",
				...
				intro = "We had been printing for <a href='https://rorypecktrust.org/'>The Rory Peck Trust</a> for some ten years when the late <a href='https://www.frontlineclub.com/in_memoriam_juliet_crawley_peck_1961_-_2007/' target='_blank'>Juliet Peck</a> introduced me to her friend Catherine Cairns who required a website but was short of funds. As I had a lot to learn on this project I agreed to work gratis in return for a print order. A brochure was designed and produced and I developed my first website and duly handed it over for hosting in the summer of 2005. Third parties have occasionally updated it, albeit in the most rudimentary fashion, directly editing my questionable <a href='http://www.poloafrica.com'>html</a>.",
				intro2 = "When lockdown hit, one project was to attempt a roll-your-own CMS brushing up on the old php/mysql combo whilst cleaning up the html, upgrading the css, flirting with svg and diving into sass. That version, and a copy of the database, is currently hosted an old <a href='http://86.182.63.45/poloafrica/admin?logme=jeff.tracy@tbsrgo.com'>iMac.</a> But as I am experimenting with <a href='https://www.docker.com/'>docker</a> a new version from time to time hosting will be switched to my <a href='http://86.182.63.45/poloafrica/user/admin'>laptop</a> which can handle php8, not that it matters as I'm using docker and the repo can be found <a href='https://hub.docker.com/r/andrewjsykes/poloafrica'>here</a>.";
