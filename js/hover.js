	...
	var U = poloAF.Util,
		...
		fader = (function () {
			var base_el,
				...
				intro2 = "When lockdown hit, one project was attempting a basic CMS brushing up on the old php/mysql combo, cleaning up the html, upgrading the css, flirting with svg. That version, and a copy of the database, is currently hosted an old iMac, but currently unavailable whilst I attempt to migrate to php8.";
