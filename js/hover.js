		...
		fader = (function () {
			var base_el,
               ...
               // imac = "<a href='http://86.155.78.122/poloafrica/admin?logme=jeff.tracy@tbsrgo.com'>iMac.</a> ",
				...
				intro4 = "When lockdown hit, one project was deploying the MAMP stack to convert the static site into a bespoke CMS whilst cleaning up the html, upgrading the css, flirting with svg and diving into sass. I have, of late, upgraded the project to php8, explored an ORM approach, discovered nginx and learned a little <a href='https://www.docker.com'>Docker</a> and this <strong>development</strong> version is currently hosted on <a href='http://35.179.3.79/' target='_blank'>AWS</a>. An <em>administrator</em> can edit content, à-la markdown, edit/upload images, manage user authorisation and more, and I've kept the use of tools and libraries to the bare minimum both in PHP and JS. I've learned a lot from this native PHP project but would have to consider it as merely a necessary <em>prelude</em> to learning and utilising a robust and secure framework like Laravel.";
