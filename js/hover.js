		...
		fader = (function () {
			var base_el,
               ...
               // imac = "<a href='http://86.155.78.122/poloafrica/admin?logme=jeff.tracy@tbsrgo.com'>iMac.</a> ",
				...
				intro = "We had been printing for <a href='https://rorypecktrust.org/'>The Rory Peck Trust</a> for some ten years when the late <a href='https://www.frontlineclub.com/in_memoriam_juliet_crawley_peck_1961_-_2007/' target='_blank'>Juliet Peck</a> introduced me to her friend Catherine Cairns who required a website but was short of funds. As I had a lot to learn on this project I agreed to work gratis in return for a print order. A brochure was designed and produced and I developed my first website and duly handed it over for hosting in the summer of 2005. Third parties have regularly updated it, albeit in the most rudimentary fashion, directly editing the html. Alas as of March 2024 the website has been retired, for the oh so very curious it can be accessed <a href='https://web.archive.org/web/20230327141639/http://poloafrica.com/trust.html'>here</a>.",
				intro2 = "When lockdown hit, one project was to attempt a roll-your-own CMS brushing up on the old php/mysql combo whilst cleaning up the html, upgrading the css, flirting with svg. That version, and a copy of the database, is currently hosted an old <a href='http://86.152.159.130/poloafrica/admin?logme=jeff.tracy@tbsrgo.com'>iMac.</a> I'm currently upgrading these old projects to php8 and experimenting with <a href='https://www.docker.com/'>docker</a> for future deployment, which just may give Catherine a fighting chance of uploading new content";
